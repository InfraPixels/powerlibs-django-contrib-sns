...
setup(
    name='powerlibs-django-contrib-sns',
    version=version,
    description="Django models integration to SNS",
    long_description=readme,
    author='Cléber Zavadniak',
    author_email='cleberman@gmail.com',
    url='https://github.com/Dronemapp/powerlibs-django-contrib-sns',
    license=license,
    packages=['powerlibs.django.contrib.sns'],
